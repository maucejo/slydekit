...
#argument-callout(kind: "State", "hide-section-slide", [bool], default: [false])[
  Boolean that indicates whether to hide the section slide when a new section starts. It is used to determine whether to display the section title slide in the presentation.
]
