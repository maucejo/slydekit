...
#let _calepin-expected-generation = "97a19c31a0555d7d-1349cde127705c16"
...
#slide("Fletcher integration", steps: 3)[
  ...
  #let draw-reveal-fletcher = draw-reveal.with(hide-fn: fletcher.hide.with(bounds: true))
  ...
  #context {
    ...
    #diagram(
      ...
      draw-reveal-fletcher(from: 2, edge(`read()`, "-|>")),

      node((1,0), `eof`, radius: 2em),
      draw-reveal-fletcher(3, edge(`close()`, "-|>")),
      node((2,0), `closed`, radius: 2em, extrude: (-2.5, 0)),
      draw-reveal-fletcher(3, edge((0,0), (2,0), `close()`, "-|>", bend: -40deg)),
    )]
  }
]
```
