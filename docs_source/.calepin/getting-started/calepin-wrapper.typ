...
#let _calepin-expected-generation = "8fb4d538bfe8dfe8-1349cde127705c16"
...
#let _raw-chunk-langs = ("python", "r", "mermaid", "dot", "tikz", "d2", "Typst")
...
#show raw.where(block: true, lang: "Typst", theme: auto): it => if _disable-raw-chunk-transforms.get() { _html-themed-raw-block(it) } else { chunk_from_raw_plain("Typst", it) }
