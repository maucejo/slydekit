...
#let _calepin-expected-generation = "6c96b7763a745b67-1349cde127705c16"
...
#let _raw-chunk-langs = ("python", "r", "mermaid", "dot", "tikz", "d2", "json")
...
#show raw.where(block: true, lang: "json", theme: auto): it => if _disable-raw-chunk-transforms.get() { _html-themed-raw-block(it) } else { chunk_from_raw_plain("json", it) }
