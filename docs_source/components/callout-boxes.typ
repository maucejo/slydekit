...
#calepin.elements.gallery(
  (
    ("../assets/components/callout-simple1.png", "Title slide", [Callout boxes - Part 1]),
    ("../assets/components/callout-simple2.png", "Progressive outline 1", [Callout boxes - Part 2]),
    ("../assets/components/callout-simple3.png", "First slide", [Callout boxes - Part 3]),
  ),
  columns: 3,
  max-width: 100%,
)
