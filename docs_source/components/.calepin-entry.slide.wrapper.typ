...
#let _calepin-expected-generation = "28574cc907d3f313-1349cde127705c16"
...
#set document(title: [Slide])
#metadata((tags: ("slide"))) <website-metadata>

#html.elem("p", attrs: (style: "color: var(--calepin-color-link); font-size: 2em; font-weight: bold;"))[Slide]
